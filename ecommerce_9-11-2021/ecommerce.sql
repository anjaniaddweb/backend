...
--
-- Host: localhost
-- Generation Time: Nov 18, 2021 at 10:35 AM
...
(17, 19, 'Dennis Lingo Shirt', 64, '../images/cat-2.jpg'),
(18, 18, 'Slim Fit Casual Shirt ', 70, '../images/men-1.jpg'),
(19, 32, '3 Piece Dress for Boys', 40, '../images/kids-3.jpg'),
(20, 24, 'Knot front mini dress', 80, '../images/product-7.jpg');
...
(19, 'Dennis Lingo Shirt', 64, 'Regular Machine Wash with like colors\r\n', '../images/cat-2.jpg', 'Men', 1),
(20, 'Cotton Casual Slim Fit Shirt', 90, 'Care Instructions Machine Wash Slim Fit\r\nNeck Style Collared', '../images/cate-3.jpg', 'Men', 1),
...
(30, 'Baby Boy Girl Clothing Set', 90, 'Dress up your young boy girl in this cool funky sky blue and grey colored full length set by bold n elegant', '../images/kids.jpg', 'Kids', 1),
(31, 'tshirt', 50, 'Care Instructions Machine Wash\r\nFit Type Regular\r\nColor Name Multicolor', '../images/tshirt.jpg', 'Kids', 1),
(32, '3 Piece Dress for Boys', 40, 'Fit Type Regular', '../images/kids-3.jpg', 'Kids', 1),
(33, 'Black Top', 40, 'Care Instructions Machine Wash\r\nFabric Cotton\r\n', '../images/kid-4.jpg', 'Kids', 1),
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
